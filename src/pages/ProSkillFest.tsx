...
const ProSkillFest = () => {
  ...
  /* gallery for "откуда все началось" */
  ...
  return (
    <main className="relative overflow-hidden" style={{ backgroundColor: "#F2F2F2" }}>
          ...
          <div className="relative z-10 w-full px-6 md:px-16 pb-12 md:pb-20">
            <div className="w-fit">
              ...
              >
                ...
                <span className="inline-block bg-[#F29727] text-white text-sm md:text-base font-bold uppercase tracking-wider px-5 py-2 rounded-full">
                  7 ноября 2026 · Москва · Регистрация открыта
                </span>
              </motion.div>
          ...
          <div className="fluid-container">
            <AnimatedSection>
              <h2 className="text-4xl md:text-6xl text-foreground mb-6">
                Откуда это{" "}
                <span className={orangeGrad}>все началось</span>
              </h2>
            </AnimatedSection>
      ...
      {/* ── AUDIENCE — "Кому сюда" ── */}
      <section className="px-3 md:px-6 xl:px-10 mt-4 relative z-10">
        <div className="rounded-[2rem] py-20 px-6 md:px-16 relative overflow-hidden" style={{ backgroundColor: "#2D3142" }}>
          {/* Decorative flowers overlapping edges */}
          <img
            src={flowersLeft}
            alt=""
            className="absolute -left-8 top-1/2 -translate-y-1/2 w-[180px] md:w-[240px] pointer-events-none z-20 opacity-90"
          />
          <img
            src={flowersRight}
            alt=""
            className="absolute -right-8 top-1/2 -translate-y-1/2 w-[180px] md:w-[240px] pointer-events-none z-20 opacity-90 hidden md:block"
          />
          ...
          <div className="fluid-container relative z-10">
            <AnimatedSection>
              <h2 className="text-4xl md:text-6xl text-white mb-12">
                Кому{" "}
                <span className={orangeGrad}>сюда</span>
              </h2>
            </AnimatedSection>
          ...
          <div className="fluid-container">
            <AnimatedSection>
              <h2 className="text-4xl md:text-6xl text-foreground mb-4">
                Как устроен{" "}
                <span className={orangeGrad}>день</span>
              </h2>
              <p className="text-muted-foreground mb-12 normal-case text-lg max-w-2xl">
        ...
        <div className="rounded-[2rem] py-20 px-6 md:px-16 relative overflow-hidden" style={{ backgroundColor: "#2D3142" }}>
          ...
          <div className="fluid-container relative z-10">
            <AnimatedSection>
              ...
              <p className="text-white/60 mb-12 max-w-2xl normal-case leading-relaxed text-lg">
                ...
                return (
                  <AnimatedSection key={i} delay={i * 0.03}>
                    <div className={`flex gap-4 md:gap-6 p-4 rounded-xl ${isBreak ? "bg-white/5" : "bg-white/10 border border-white/10"}`}>
                      <span className="text-[#F29727]/80 text-sm font-mono whitespace-nowrap min-w-[120px] shrink-0">
                        {item.time}
                      </span>
                      <div className="flex-1 min-w-0">
                        ...
                        {item.speaker && (
                          <p className="text-[#F29727]/70 text-xs mt-1 normal-case">
      ...
      <section className="px-3 md:px-6 xl:px-10 mt-4 relative z-10">
        <div className="rounded-[2rem] py-20 px-6 md:px-16" style={{ backgroundColor: "#F29727" }}>
          <div className="fluid-container">
            <AnimatedSection>
              <h2 className="text-4xl md:text-6xl text-white mb-4">
                Что говорят{" "}
                <span className="bg-gradient-to-r from-amber-100 via-white via-40% to-amber-200 bg-clip-text text-transparent">те, кто был</span>
              </h2>
              <p className="text-white/80 text-base md:text-lg mb-12 max-w-xl font-normal normal-case">
      ...
      <section className="px-3 md:px-6 xl:px-10 mt-4 relative z-10">
        <div className="bg-background rounded-[2rem] py-20 px-6 md:px-16">
          <div className="fluid-container">
            ...
            <div className="flex flex-col md:flex-row gap-8 max-w-4xl items-center">
              ...
              <AnimatedSection delay={0.1} className="flex-1">
                <h3 className="text-xl mb-4 normal-case">Loft Красный Октябрь</h3>
                ...
                <div className="space-y-3 text-foreground/80 text-sm normal-case">
                  <div className="flex items-start gap-3">
                    <span className="w-2.5 h-2.5 rounded-full bg-[#F29727] shrink-0 mt-1.5" />
        ...
        <div className="bg-background rounded-[2rem] py-20 px-6 md:px-16">
          <div className="fluid-container">
            ...
            <div className="grid md:grid-cols-2 gap-6 max-w-4xl">
              ...
              <AnimatedSection delay={0.1}>
                <div className="rounded-2xl p-8 h-full flex flex-col text-white" style={{ backgroundColor: "#300000" }}>
            ...
            <div className="grid md:grid-cols-2 gap-6 max-w-4xl mt-12">
              <AnimatedSection>
                <Link to="/uchitelya/kurs" className="block bg-card border border-border rounded-2xl p-6 hover:border-[#F29727]/30 transition-colors h-full">
                  <span className="text-xs text-[#F29727] uppercase tracking-wider">Hilderstone College</span>
                  ...
                  <span className="text-[#F29727] text-sm font-semibold inline-flex items-center gap-1">
              ...
              <AnimatedSection delay={0.1}>
                <Link to="/partnerstvo" className="block bg-card border border-border rounded-2xl p-6 hover:border-[#F29727]/30 transition-colors h-full">
                  <span className="text-xs text-[#F29727] uppercase tracking-wider">Для руководителей</span>
