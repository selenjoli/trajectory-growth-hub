        ...
        <div className="grid md:grid-cols-3 gap-6">
          {doors.map((d) => (
            ...
            >
              ...
              <p className="text-[15px] text-muted-foreground mb-6 normal-case font-normal">{d.text}</p>
              <a
                href={d.href}
                className="inline-block bg-action text-action-foreground font-bold uppercase px-5 py-3 rounded-lg text-sm hover:brightness-110 transition-all tracking-wide"
              >
                {d.link}
              </a>
            </div>
