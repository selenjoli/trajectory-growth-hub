        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {rostItems.map((item) => (
            <div key={item.letter} className="bg-card rounded-lg p-6 border border-border">
              <span className="text-5xl font-extrabold text-primary/15 font-display block leading-none">
                {item.letter}
              </span>
              <p className="text-xs uppercase tracking-widest text-accent font-semibold mt-2 mb-3">
                {item.word}
              </p>
