...
const cards = [
  ...
  },
  {
    ...
    text: "Ассоциация объединяет 15 центров из разных городов России. Совместные программы, обмен опытом, профессиональное сообщество — для тех, кто строит дополнительное образование всерьёз.",
    link: "О партнёрстве →",
    href: "/partnerstvo",
  },
];
