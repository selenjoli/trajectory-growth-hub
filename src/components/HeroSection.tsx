  ...
  return (
    <section className="relative min-h-screen flex items-center">
      ...
      <div className="relative z-10 container mx-auto px-5">
        ...
        <a
          href="#activities"
          className="inline-block bg-action text-action-foreground font-bold uppercase px-7 py-4 rounded-lg hover:brightness-110 transition-all text-sm tracking-wide"
        >
          Узнать больше ↓
        </a>
      </div>
